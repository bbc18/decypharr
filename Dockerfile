...
RUN --mount=type=cache,target=/go/pkg/mod \
    ...
    go build -trimpath \
    -ldflags="-w -s -X github.com/bbc18/decypharr/pkg/version.Version=${VERSION} -X github.com/bbc18/decypharr/pkg/version.Channel=${CHANNEL}" \
    -o /decypharr
...
LABEL org.opencontainers.image.source = "https://github.com/bbc18/decypharr"
LABEL org.opencontainers.image.title = "decypharr"
LABEL org.opencontainers.image.authors = "sirrobot01"
LABEL org.opencontainers.image.documentation = "https://github.com/bbc18/decypharr/blob/main/README.md"
